...
/// `delegation.max_spawn_depth` hint. Requests and profile hints are
/// child-relative limits: after conversion to an absolute cap, they may narrow
/// but never widen the authoritative inherited absolute budget.
